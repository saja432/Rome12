...
local function isTargeted(ball, char)
    ...
    local targetValue = char:FindFirstChild("Target")
    if targetValue and targetValue:IsA("ObjectValue") and targetValue.Value == LocalPlayer then return true end
...
local function fireParry()
    ...
    local ok = false
    if parry:IsA("RemoteEvent") or parry:IsA("UnreliableRemoteEvent") then
