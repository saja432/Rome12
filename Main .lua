...
local function getRemotes()
    ...
    local parry = remotes:FindFirstChild("ParryButtonPress")
...
local function isTargeted(ball, char)
    ...
    if target ~= nil then
        if target == LocalPlayer.Name or target == tostring(LocalPlayer.UserId) then return true end
        if typeof(target) == "Instance" and target == LocalPlayer then return true end
    end
